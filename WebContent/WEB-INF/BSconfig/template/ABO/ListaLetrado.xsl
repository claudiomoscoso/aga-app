...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns:xalan="http://xml.apache.org/xslt">
	...
	<xsl:template match="/">
		...
		<H1 class="cTitle">Listado de Letrados</H1>
		...
		<table class="cList" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td class="cDataTD"><a href="#">Juan Anquemel</a></td>
				<td class="cDataTD">23/08/2007</td>
				<td class="cDataTD">Abogado</td>
			...
			<tr>
				...
				<td class="cDataTD"><a href="#">Claudio Hidalgo</a></td>
				<td class="cDataTD">03/09/2007</td>
				<td class="cDataTD">Procurador</td>
				<td class="cDataTD"><a href="#" onclick="jacascript:confirm('Seguro de borrar el cliente y todos sus antecedentes?');">Eliminar</a></td>
			</tr>
		</table>
		<br/>
