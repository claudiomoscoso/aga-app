...
public class GetMenu extends BSAbstractProcess implements BSProcess {
    ...
    public BSServiceData execute(BSServiceData serviceData) throws BSException {
        ...
        serviceData.addResponseNode(menu);
    ...
    private void checkOption(Node option, String rol, BSExecutor exec) throws BSException {
        ...
        try {
            ResultSet rs = exec.queryResultSet(conn, GetMenu.SQL, params);
