...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<form name="f" id="f" method="post" action="/{/Service/Context/SiteName}/">
			<input value ="{/Service/Response/Fields/Record/cID}" name="fldID" type="hidden"/>
			<table width="80%">
				<caption>Antecedentes Personales</caption>
				<tr>
					<td class="cLabel">Fecha Registro:</td>
					<td class="cData">
						<xsl:value-of select="substring-after(/Service/Response/Fields/Record/cFechaRegistro, ';')" />
					</td>
				</tr>
				<tr>
					<td class="cLabel">R.U.T.:</td>
					<td class="cData">
						<input name="fldRUT" type="text" id="fldRUT" value="{/Service/Response/Fields/Record/cRUT}" 
				...
				<tr>
					...
					<td class="cData">
						<input id="fldNombre" name="fldNombre" type="text" value="{/Service/Response/Fields/Record/cNombre}" maxlength="50" size="50"/>
						*
					</td>
				</tr>
				<tr>
					...
					<td class="cData">
						...
						<input id="fldApellidoPaterno" name="fldApellidoPaterno" type="text"
							value="{/Service/Response/Fields/Record/cApellidoPaterno}" maxlength="20" size="20"/>
						* Materno:
						<input id="fldApellidoMaterno" name="fldApellidoMaterno" type="text"
							value="{/Service/Response/Fields/Record/cApellidoMaterno}" maxlength="20" size="20"/>
						*
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cData">
						<input type="text" name="fldFechaNacimiento" id="fldFechaNacimiento" maxlength="10" size="10"
							value="{substring-after(/Service/Response/Fields/Record/cFechaNacimiento, ';')}"/>* (28/02/1990)
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldDireccion" name="fldDireccion" type="text" value="{/Service/Response/Fields/Record/cDireccion}" maxlength="20" size="20"/>
						* N&#250;mero:
						<input id="fldNumero" name="fldNumero" type="text" value="{/Service/Response/Fields/Record/cNumero}" maxlength="5" size="5"/>
						*
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldVilla" name="fldVilla" type="text" value="{/Service/Response/Fields/Record/cVilla}" 
							maxlength="30" size="30"/>
						Block
						<input id="fldBlock" name="fldBlock" type="text" value="{/Service/Response/Fields/Record/cBlock}" 
							 maxlength="5" size="5"/>
						Depto.
						<input id="fldDepartamento" name="fldDepartamento" type="text"
							value="{/Service/Response/Fields/Record/cDepartamento}"  maxlength="5" size="5"/>
					</td>
				</tr>
					...
					<td>
						<select id="fldComuna" name="fldComuna">
							<xsl:for-each select="/Service/Response/Fields/ListComuna/Record">
								<option value="{cID}">
									<xsl:if test="/Service/Response/Fields/Record/cComuna = cID">
				...
				<tr>
					...
					<td class="cData">
						<input id="fldCodigoPostal" name="fldCodigoPostal" type="text"
							value="{/Service/Response/Fields/Record/cCodigoPostal}" 
				...
				<tr>
					...
					<td class="cData">
						...
						<input id="fldTelefonoLaboral" name="fldTelefonoLaboral" type="text" 
							value="{/Service/Response/Fields/Record/cTelefonoLaboral}" 
							 maxlength="12" size="12"/>
						Anexo:
						<input id="fldAnexo" name="fldAnexo" type="text" 
							value="{/Service/Response/Fields/Record/cAnexo}" 
							 maxlength="4" size="4"/>
						Fijo:
						<input id="fldTelefono" name="fldTelefono" type="text" 
							value="{/Service/Response/Fields/Record/cTelefono}" 
							 maxlength="12" size="12"/>*
						 Fax:
						<input id="fldFax" name="fldFax" type="text" value="{/Service/Response/Fields/Record/cFax}" 
							maxlength="12" size="12"/>
						Celular:
						<input id="fldCelular" name="fldCelular" type="text" value="{/Service/Response/Fields/Record/cCelular}" 
							maxlength="12" size="12"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldNumeroCasilla" name="fldNumeroCasilla" type="text" 
							value="{/Service/Response/Fields/Record/cNumeroCasilla}" 
							 maxlength="10" size="10"/>
					</td>
				</tr>
					...
					<td>
						<select id="fldReligion" name="fldReligion">
							<xsl:for-each select="/Service/Response/Fields/ListReligion/Record">
								<option value="{cID}">
									<xsl:if test="/Service/Response/Fields/Record/cReligion = cID">
										<xsl:attribute name="selected"/>
									</xsl:if>
									<xsl:value-of select="cNombre" />
								</option>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldOcupacion" type="text" name="fldOcupacion" value="{/Service/Response/Fields/Record/cOcupacion}" 
							maxlength="30" size="30"/>*
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldEmpleador" type="text" name="fldEmpleador" value="{/Service/Response/Fields/Record/cEmpleador}" 
							maxlength="30" size="30"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldTitulo" type="text" name="fldTitulo" value="{/Service/Response/Fields/Record/cTitulo}" 
							maxlength="30" size="30"/>
					</td>
				</tr>
					...
					<td>
						<select id="fldNacionalidad" name="fldNacionalidad">
							<xsl:for-each select="/Service/Response/Fields/ListNacionalidad/Record">
								<option value="{cID}">
									<xsl:if test="/Service/Response/Fields/Record/cNacionalidad = cID">
										<xsl:attribute name="selected"/>
									</xsl:if>
									<xsl:value-of select="cNombre" />
								</option>
				...
				<tr>
					...
					<td class="cData">
						<input id="fldMail" type="text" name="fldMail" value="{/Service/Response/Fields/Record/cMail}" 
				...
				<tr>
					...
					<td class="cData">
						<input id="fldIdioma1" type="text" name="fldIdioma1" value="{/Service/Response/Fields/Record/cIdioma1}" 
				...
				<tr>
					...
					<td class="cData">
						<input id="fldIdioma2" type="text" name="fldIdioma2" value="{/Service/Response/Fields/Record/cIdioma2}" 
							maxlength="20" size="20"/>&#160;
				...
				<tr>
					...
					<td>
						<select id="fldGrupo" name="fldGrupo">
							<xsl:for-each select="/Service/Response/Fields/ListGrupos/Record">
								<option value="{cID}">
									<xsl:if test="/Service/Response/Fields/Record/cGrupo = cID">
										<xsl:attribute name="selected"/>
									</xsl:if>
									<xsl:value-of select="cNombre" />
								</option>
					...
					<td class="cData">
						<input id="fldNumeroMiembroActivo" type="text" name="fldNumeroMiembroActivo" 
							value="{/Service/Response/Fields/Record/cNumeroMiembroActivo}" maxlength="5" size="5"/>**
					</td>
				</tr>
				<tr>
					...
					<td>
						<select id="fldUnidad" name="fldUnidad">
							<xsl:for-each select="/Service/Response/Fields/ListUnidad/Record">
								<option value="{cID}">
									<xsl:if test="/Service/Response/Fields/Record/cUnidad = cID">
										<xsl:attribute name="selected"/>
									</xsl:if>
									<xsl:value-of select="cNombre" />
								</option>
			...
			<input type="hidden" name="fldFechaRegistro" value="{substring-before(/Service/Response/Fields/Record/cFechaRegistro, ';')}" />
...
<!-- 
 ...
 -->
		<script language="JavaScript1.1" type="text/javascript">
			<xsl:comment>
				function onLoadPage(){
						if("<xsl:value-of select="/Service/Response/Fields/Record/cMasculino"/>" == "1"){
						...
						for(var i = 0; i &lt; gentilicios.length;i+=1){
							if(gentilicios[i].value == "<xsl:value-of select="/Service/Response/Fields/Record/cGentilicio"/>"){
						...
						for(var i = 0; i &lt; estadosCiviles.length; i+= 1){
							if(estadosCiviles[i].value == "<xsl:value-of select="/Service/Response/Fields/Record/cEstadoCivil"/>"){
						...
						document.getElementById("fldIdiomaLee1").checked = "<xsl:value-of select="/Service/Response/Fields/Record/cIdiomaLee1"/>" == "1";
						document.getElementById("fldIdiomaHabla1").checked = "<xsl:value-of select="/Service/Response/Fields/Record/cIdiomaHabla1"/>" == "1";
						document.getElementById("fldIdiomaEscribe1").checked = "<xsl:value-of select="/Service/Response/Fields/Record/cIdiomaEscribe1"/>" == "1";

						document.getElementById("fldIdiomaLee2").checked = "<xsl:value-of select="/Service/Response/Fields/Record/cIdiomaLee2"/>" == "1";
						document.getElementById("fldIdiomaHabla2").checked = "<xsl:value-of select="/Service/Response/Fields/Record/cIdiomaHabla2"/>" == "1";
						document.getElementById("fldIdiomaEscribe2").checked = "<xsl:value-of select="/Service/Response/Fields/Record/cIdiomaEscribe2"/>" == "1";

						var cargo = null;
						var cargos = null;
						<xsl:for-each select="/Service/Response/Fields/Record/Cargos/Record">
							cargo = "<xsl:value-of select="cCargo"/>";
							cargos = document.getElementsByName("fldCargo");
						...
						for(var i = 0; i &lt; niveles.length; i+= 1){
							if(niveles[i].value == "<xsl:value-of select="/Service/Response/Fields/Record/cNivelFormacion"/>"){
				...
				function aceptar(){ 
					...
					if(msg.length > 0){ 
						...
						document.getElementById("f").bsServiceName.value = "SCO.UpdateDYG"; 
						document.getElementById("f").submit(); 
					} 
				}
