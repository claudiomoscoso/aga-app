...
public class HorizontalPanel extends PdfComponent {
	...
	public HorizontalPanel(PdfComponent components[]) {
	...
	public Element render(PdfWriter writer) {
		try {
			com.lowagie.text.Table table = new com.lowagie.text.Table(components.length);
